            ...
            <div class="row">
                <div class="col-lg-6 mb-sm-15">
                    <div class="toggle_info">
                        <span><i class="fi-rs-user mr-10"></i><span
                                class="text-muted">Already have an account?</span> <a href="#loginform"
                                    ...
                                    <div class="chek-form">
                                        <div class="custome-checkbox">
                                            ...
                                            <label class="form-check-label"
                                                   for="remember"><span>Remember me</span></label>
                                        </div>
                                    </div>
                            ...
                            <div class="checkbox">
                                <div class="custome-checkbox">
                                    ...
                                    <label class="form-check-label label_info" data-bs-toggle="collapse"
                                           ...
                                           for="createaccount"><span>Create an account?</span></label>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="chek-form">
                                    <div class="custome-checkbox">
                                        ...
                                        <label class="form-check-label label_info" data-bs-toggle="collapse"
                                               ...
                                               aria-controls="collapseAddress" for="differentaddress"><span>Ship to a different address?</span></label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    <td class="image product-thumbnail"><img src="assets/imgs/shop/product-1-1.jpg"
                                                                             alt="#"></td>
                                    <td>
                                        <h5><a href="shop-product-full.html">Yidarton Women Summer Blue</a></h5> <span
                                ...
                                <tr>
                                    <th>Total</th>
                                    <td colspan="2" class="product-subtotal"><span class="font-xl text-brand fw-900">$280.00</span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="payment_option">
                                ...
                                <div class="custome-radio">
                                    ...
                                    <label class="form-check-label" for="exampleRadios4" data-bs-toggle="collapse"
                                           data-target="#checkPayment" aria-controls="checkPayment">Check
                                        Payment</label>
                                ...
                                <div class="custome-radio">
                                    ...
                                    <div class="form-group collapse in" id="paypal">
                                        <p class="text-muted mt-5">Pay via PayPal; you can pay with your credit card if
