                        ...
                        <ul>
                            <li class="menu-item lang-menu menu-item-has-children parent">
                                <a title="English" href="#"><span class="img label-before"><img
                                            ...
                                            alt="lang-en">
                                    </span>English<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                    ...
                                    @if(Auth::user()->utype === 'ADM')
                                        <li class="menu-item menu-item-has-children parent">
                                            ...
                                            <ul class="submenu curency">
                                                ...
                                                <li class="menu-item">
                                                    <a title="Categories" href="{{ route('admin.products') }}">
                                                        Products
                                                    </a>
                                                </li>
                                                <li class="menu-item">
                                                ...
                                                <li class="menu-item">
                                                    <a title="Manager Home Category"
                                                       href="{{ route('admin.homecategories') }}">
                ...
                <div class="mid-section main-info-area">
                    ...
                    <div class="wrap-logo-top left-section">
                        <a href="{{ URL::to('/') }}" class="link-to-home"><img
                                src="{{ asset('assets/images/logo-top-1.png') }}"
                                alt="mercado"></a>
                    </div>
                    ...
                    <div class="container">
                        <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                            <li class="menu-item home-icon">
                                <a href="{{ URL::to('/') }}" class="link-term mercado-item-title">
                            ...
                            <li class="menu-item">
                                <a href="{{ URL::to('/cart') }}" class="link-term mercado-item-title">Cart</a>
                            </li>
                            <li class="menu-item">
