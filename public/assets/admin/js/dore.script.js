...
$.dore = function (element, options) {
    ...
    function init() {
        ...
        if (typeof Chart !== "undefined") {
            ...
            if (document.getElementById("salesGraphic")) {
                var salesChart = document.getElementById("salesGraphic").getContext("2d");
                var myChart = new Chart(salesChart, {
                    type: "LineWithShadow",
                    options: {
                        plugins: {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: "",
                                data: JSON.parse(document.getElementById('data-sales').innerHTML),
                                borderColor: themeColor1,
                                pointBackgroundColor: foregroundColor,
                                pointBorderColor: themeColor1,
                                pointHoverBackgroundColor: themeColor1,
            ...
            if (document.getElementById("orderGraphic")) {
                var salesChart = document.getElementById("orderGraphic").getContext("2d");
                var myChart = new Chart(salesChart, {
                    type: "LineWithShadow",
                    options: {
                        plugins: {
                    ...
                    data: {
                        labels: JSON.parse(document.getElementById('order-days').innerHTML),
                        datasets: [
                            {
                                label: "",
                                data: JSON.parse(document.getElementById('order-sales').innerHTML),
                                borderColor: themeColor1,
                                pointBackgroundColor: foregroundColor,
                                pointBorderColor: themeColor1,
                                pointHoverBackgroundColor: themeColor1,
